...
/* harmony export */ });
/* harmony import */ var _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dfinity/agent */ "./node_modules/@dfinity/agent/lib/esm/index.js");
/* harmony import */ var tweetnacl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tweetnacl */ "./node_modules/@dfinity/identity/node_modules/tweetnacl/nacl-fast.js");
...
/* harmony import */ var _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dfinity/agent */ "./node_modules/@dfinity/agent/lib/esm/index.js");
/* harmony import */ var borc__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! borc */ "./node_modules/borc/src/index.js");
/* harmony import */ var tweetnacl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tweetnacl */ "./node_modules/@dfinity/identity/node_modules/tweetnacl/nacl-fast.js");
...
/***/ "./node_modules/@dfinity/identity/node_modules/tweetnacl/nacl-fast.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@dfinity/identity/node_modules/tweetnacl/nacl-fast.js ***!
  \****************************************************************************/
...
(function() {
  ...
  if (crypto && crypto.getRandomValues) {
    ...
    // Node.js.
    crypto = __webpack_require__(/*! crypto */ "?7fc2");
...
/***/ "./src/declarations/infinitinote_backend/index.js":
/*!********************************************************!*\
  !*** ./src/declarations/infinitinote_backend/index.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "idlFactory": () => (/* reexport safe */ _infinitinote_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "infinitinote_backend": () => (/* binding */ infinitinote_backend)
/* harmony export */ });
/* harmony import */ var _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @dfinity/agent */ "./node_modules/@dfinity/agent/lib/esm/index.js");
/* harmony import */ var _infinitinote_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./infinitinote_backend.did.js */ "./src/declarations/infinitinote_backend/infinitinote_backend.did.js");
...
const createActor = function (canisterId) {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_infinitinote_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
    ...options.actorOptions
  });
};
const infinitinote_backend = createActor(canisterId);

/***/ }),

/***/ "./src/declarations/infinitinote_backend/infinitinote_backend.did.js":
/*!***************************************************************************!*\
  !*** ./src/declarations/infinitinote_backend/infinitinote_backend.did.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const idlFactory = _ref => {
  ...
  return IDL.Service({
    'add_note_to_notebook': IDL.Func([IDL.Text, IDL.Text, IDL.Text, IDL.Vec(IDL.Text)], [IDL.Text], []),
    'add_notebook_for_principal': IDL.Func([IDL.Text, IDL.Text], [IDL.Text], []),
    'add_tag_to_notebook': IDL.Func([IDL.Text, IDL.Text], [IDL.Text], []),
    'create_notebook': IDL.Func([IDL.Text], [IDL.Text], []),
    'get_notebooks_for_principal': IDL.Func([], [IDL.Vec(Notebook)], []),
    'get_notes_for_notebook': IDL.Func([IDL.Text], [IDL.Vec(Note)], []),
...
"use strict";
/*!****************************************************!*\
  !*** ./src/infinitinote_frontend/assets/bridge.js ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "backend_hello": () => (/* binding */ backend_hello),
/* harmony export */   "greet": () => (/* binding */ greet)
/* harmony export */ });
/* harmony import */ var _declarations_infinitinote_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/infinitinote_backend */ "./src/declarations/infinitinote_backend/index.js");
...
window.call_backend_func = async function () {
  var result;
...
window.onMount = async function () {
  window.authClient = await _dfinity_auth_client__WEBPACK_IMPORTED_MODULE_1__.AuthClient.create();
};
window.onAuthenticated = async function () {
  ...
  var newbackend = (0,_declarations_infinitinote_backend__WEBPACK_IMPORTED_MODULE_0__.createActor)(_declarations_infinitinote_backend__WEBPACK_IMPORTED_MODULE_0__.canisterId, actorOptions);
...
window.authenticate = async function () {
  await authClient.login({
    identityProvider: "http://localhost:4943/?canisterId=rno2w-sqaaa-aaaaa-aaacq-cai",
    onSuccess: async () => {
...
window.backend_hello = function () {
  ...
  window.backend.greet("PUDDING").then(result => {
    window.backend_result = result;
  });
};
...
async function greet() {
  ...
  await _declarations_infinitinote_backend__WEBPACK_IMPORTED_MODULE_0__.infinitinote_backend.greet('test');
}
